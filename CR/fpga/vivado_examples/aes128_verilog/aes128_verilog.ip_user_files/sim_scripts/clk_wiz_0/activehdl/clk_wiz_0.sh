...
#
# Generated by Vivado on Wed Jun 20 15:50:43 -0400 2018
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/DPAWS/Documents/CHRIS/Countermeasures/CR/fpga/vivado_examples/aes128_verilog/aes128_verilog.cache/compile_simlib/activehdl"
  fi
